...
<html>
<head>
  <title>Blood Donation Camp 2018</title>
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta property="og:title" content="Blood Donation Camp 2018" />
  <meta property="og:type" content="Event" />
  <meta property="og:url" content="http://www.akgec.in/bdc18" />
  <meta name="theme-color" content="#750715" />
  <meta name="apple-mobile-web-app-capable" content="yes">
  <meta name="description" content="Blood Donation Camp is annual Event held in AKGEC, Ghaziabad with Rotary Blood Bank, Noida">
  <meta name="author" content="Software Incubator">
  <link rel="icon" href="assets/AKGEC.svg" type="image/svg" sizes="16x16">
</head>
<body>
...
<nav class="navbar navbar-expand-lg fixed-top navbar-dark">
  ...
  <a class="navbar-brand ml-auto" href="#">Rotary Club of Noida, India   
    <hr>
  </a>
</nav>


<div class="section-scroll scrollable-section landing container" data-section-title="Home"> 

  <div id="svgoverlay"></div>
  <img src="assets/beatbg.svg" id="svgbeat">
...
<ul class="nav nav-tabs wow fadeIn" data-wow-delay="0.5s" role="tablist">
  <li class="nav-item">
    <a class="nav-link active" href="#ricmartin" role="tab" data-toggle="tab">Ric Martin</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="#socialaware" role="tab" data-toggle="tab">Social Awareness</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="#tathya" role="tab" data-toggle="tab">Tathya</a>
  </li>
    <li class="nav-item">
    <a class="nav-link" href="#mythos" role="tab" data-toggle="tab">Mythos</a>
  </li>
</ul>

<!-- Tab panes -->
<div class="tab-content wow fadeIn" data-wow-delay="0.5s">
    <div role="tabpanel" class="tab-pane fade show active" id="ricmartin">
      <h1 class="tabtitle">RIC MARTIN, THE "WALKING TALKING PLATELET FACTORY"</h1>
      <img src="assets/ricmartin.png" class="img-fluid tab-img" >
      <span class="tabtext">
    ...
    <div role="tabpanel" class="tab-pane fade" id="socialaware">
        <h1 class="tabtitle">SOCIAL AWARENESS</h1>
        <img src="assets/socialaware.png" class="img-fluid tab-img" >
        <span class="tabtext">
    ...
    <div role="tabpanel" class="tab-pane fade" id="tathya">
        <h1 class="tabtitle">TATHYA</h1>
        <img src="assets/bloodcell.png" class="img-fluid tab-img" >
        <span class="tabtext">
    ...
    <div role="tabpanel" class="tab-pane fade" id="mythos">
      <h1 class="tabtitle">MYTHOS</h1>
      <img src="assets/myth.png" class="img-fluid tab-img" >
      <span class="tabtext">
  ...
  <div class="col-8">
      ...
      <div class="subsection wow fadeIn" data-wow-delay="0.5s">
        <h1 class="mythtitle">Fact</h1>
        <span id="typedfact"></span> <span class="cursor"></span>
      </div>
  </div>
  </div>
...
<div class="section-scroll scrollable-section gallery container" data-section-title="Gallery"> 

  <h1 class="sectionheading wow fadeIn" data-wow-delay="0.5s">Gallery</h1>

  <div id="gallery" class="wow fadeIn" data-wow-delay="0.5s">
    <div><img src="assets/gallery/1.jpg" class="img-fluid"></div>
    <div><img src="assets/gallery/2.jpg" class="img-fluid" ></div>
    <div><img src="assets/gallery/3.jpg" class="img-fluid"></div>
    <div><img src="assets/gallery/4.jpg" class="img-fluid"></div>
  </div>

</div>

<div class="section-scroll scrollable-section team container" data-section-title="Team"> 
...
<script type="text/javascript" src="js/sectionScroller.min.js"></script>
...
<script type="text/javascript">
$("#landingquotes").typing({

  strings: [' "A life may depend on a gesture from you, a bottle of Blood! "', 
  ' "The blood you donate gives someone another chance at life! "', 
  ' "Tears of a mother cannot save her Child. But your Blood can! "',
  ' "To the young and healthy its no loss. To sick its hope of life! "'],
...
$("#typedmyth").typing({
  ...
  strings: [' "I will gain weight by donating blood."', 
  ' "If I donate blood I am susceptible to contact diseases like HIV."', 
  ' "I suffer from diabetes, I cannot donate blood."',
...
$("#typedfact").typing({
  ...
  strings: [' "People of our country requires 5 crore units of blood every year."', 
  ' "And only 80 lakh units are donated in a year."', 
